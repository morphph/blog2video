...
*Here's the stack that does it. Most platforms end at the dashboard and hand the rest to you. The right side is the loop Opik runs on its own.*
...
*Ollie works through a fix in the side panel, reading and editing files only after you approve each step.*
