...
![Cover title card "LESSONS FROM SHORTCUT — Building a good vertical agent", with a long-tail frequency curve shaded from deep green (the hot, bread-and-butter head) fading to grey (the rare long tail), and three stacked tier bars beneath labeled L1 / L2 / L3 — a visual restatement of the article's core memory-hierarchy metaphor.](images/cover.jpg)
