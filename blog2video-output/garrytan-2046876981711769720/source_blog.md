...
Engagement: 918K views, 1,655 likes, 4,831 bookmarks, 222 reposts, 90 replies
...
> name: context-now
> description: "ALWAYS-ON discipline: run context-now.mjs before making ANY time-sensitive claim. Never do UTC→PT conversion in your head."
...
A *resolver* is a routing table for context: when task type X appears, load skill Y. I wrote about resolvers in detail elsewhere. Each skill needs a trigger entry in AGENTS.md, the file that teaches the agent what skills exist and when to use them.
