...
Engagement: 1.1M views, 3,045 likes, 9,629 bookmarks, 492 reposts, 108 replies
...
- "Fat Skills, Fat Code, Thin Harness" introduced the core architecture.
- "Resolvers" covered the routing table for intelligence.
- "The LOC Controversy" was about how every technical person just multiplied themselves by 100x to 1000x.
- "Naked models are stupider" argued that the model is the engine, not the car.
- "The skillify manifesto" explained why LangChain raised $160M and gave you a squat rack and dumbell set without a workout plan, and then gave you that workout plan you needed.
