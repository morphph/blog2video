...
你团队的 Agent Harness，是不是某天就被推倒重写过一遍？换框架，自己造轮子，过半年又想换。这个循环不是你团队的问题。iii.dev 创始人 Mike Piccolo 写了一篇长文，标题就叫《How to build your own agent harness》。他的判断很直接——大家都用错了 Harness 这个词，它根本不该是一个你 import 的框架。
