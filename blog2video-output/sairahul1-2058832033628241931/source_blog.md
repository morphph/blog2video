...
![Article cover image](images/image_1_cover.jpg)
...
![Vibe coding loop diagram — the productive-feeling but failing loop](images/image_2_vibe_loop.jpg)
...
![Factory shift — from vibe coding to a software factory](images/image_3_factory_shift.jpg)
...
![Agent 1 the Codebase Researcher](images/image_4_agent1_researcher.jpg)
...
![Agent 2 the Story Writer](images/image_5_agent2_storywriter.jpg)
...
![Agent 3 the Spec Writer](images/image_6_agent3_specwriter.jpg)
...
![Agent 4 the Backend Builder](images/image_7_agent4_backend.jpg)
...
![Agent 5 the Frontend Builder](images/image_8_agent5_frontend.jpg)
...
![Agent 6 the Test Verifier](images/image_9_agent6_test_verifier.jpg)
...
![Agent 7 the Implementation Validator](images/image_10_agent7_validator.jpg)
...
![Full 7-agent chain flow with 3 human checkpoints](images/image_11_chain_flow.jpg)
...
![CLAUDE.md as durable cross-session memory](images/image_12_claudemd.jpg)
...
![8-step weekend setup checklist](images/image_13_setup_checklist.jpg)
...
→ **Researcher** — maps the code before anything is built (Read only)
→ **Story Writer** — turns idea into user story with acceptance criteria (Read only)
→ **Spec Writer** — turns story into technical brief (Read only)
→ **Backend Builder** — builds API, services, jobs, unit tests (backend folders only)
→ **Frontend Builder** — builds components, pages, hooks, UI tests (frontend folders only)
→ **Test Verifier** — writes acceptance tests against the user story (test files only)
