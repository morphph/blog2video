...
[SLIDE 1: cover] (0:00 - 0:43)

你重度用 Claude Code 一段时间后，有没有发现它越跑越懒？该调工具不调。这不是模型笨。Anthropic Claude Code 团队的工程师 Thariq 给出了官方解药，叫 dynamic workflows——让 Claude 在每个任务开始之前，自己临时写一份只属于这个任务的 harness。

[SLIDE 2: principle] (0:43 - 2:16)

我先说为什么这件事值得专门做一期。在过去几乎所有关于 harness 的讨论里，harness 都是一个静态的、工程师设计好的东西。区别只在于谁来设计、设计成什么形状。
...
[SLIDE 7: comparison_cards] (8:13 - 10:20)
...
[SLIDE 14: summary] (21:26 - 24:04)

回到一开始那个判断——这是 harness 这个词的一次定义迁移。

在过去几乎所有的讨论里，harness 都是工程师写好的脚手架。设计者是人，产出是一个长期的工程资产。
