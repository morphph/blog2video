...
**By Harrison Chase | April 11, 2026 | 7 min read**
...
Memory (and therefore harnesses) should be separate from model providers. You should want optionality to try out whatever models are best for your use case. Model providers are incentivized to create lock in via memory.
...
_Thank you to a few people for review and thoughts:_
