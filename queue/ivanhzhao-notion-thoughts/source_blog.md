...
![Teenage Andrew Carnegie and his younger brother (left); Pittsburgh steel factories during the Gilded Age (right)](images/image_1.jpg)

![Pittsburgh steel factories during the Gilded Age](images/image_2.jpg)
...
![Early movies often looked like stage plays, with one camera focused on the stage](images/image_3.jpg)
...
![The most popular form of AI today looks like Google search of the past — an example of driving into the future via the rearview mirror](images/image_4.jpg)
...
My co-founder Simon was what we call a 10x programmer, but he rarely writes code these days. Walk by his desk and you'll see him orchestrating three or four AI coding agents at once, and they don't just type faster, they think, which together makes him a 30-40x engineer. He queues tasks before lunch or bed, letting them work while he's away. He's become a manager of infinite minds.

![A 1970s Scientific American study on locomotion efficiency inspired Steve Jobs's famous "bicycle for the mind" metaphor — except we've been pedaling on the Information Superhighway for decades since](images/image_5.jpg)
...
![Comparing coding agents with knowledge work: knowledge work is more fragmented and less verifiable](images/image_6.jpg)
...
![The Red Flag Act of 1865 required a flag bearer to walk ahead of the vehicle — an example of undesirable "human in the loop"](images/image_7.jpg)
...
![Companies are a recent invention — they degrade as they scale and reach their limit](images/image_8.jpg)

![Organizational chart for the New York and Erie Railroad, 1855 — the modern corporation and org chart evolved with the railroad companies](images/image_9.jpg)
...
![The Woolworth building was the tallest building in the world upon completion in NYC, 1913 — a wonder of steel](images/image_10.jpg)
...
![A mill with a water wheel to power its operations — water was powerful but unreliable and restricted mills to a few locations and seasonality](images/image_11.jpg)
...
![A textile factory in Lancashire, UK, powered by steam engines — 1835 engraving by Thomas Allom](images/image_12.jpg)
