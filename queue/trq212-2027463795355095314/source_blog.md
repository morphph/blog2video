...
## Lesson 1: Building the AskUserQuestion Tool

![Image 1](https://pbs.twimg.com/media/HCLxg2JbsAA3Ag_?format=jpg&name=small)
...
![Image 2](https://pbs.twimg.com/media/HCL0gcObkAA4tKt?format=jpg&name=small)
...
This tool allowed us to prompt Claude for a structured output and it helped us ensure that Claude gave the user multiple options. It also gave users ways to compose this functionality, for example calling it in the Agent SDK or referring to it in skills.
...
## Lesson 2: From TodoWrite to Task Tools

![Image 3](https://pbs.twimg.com/media/HCLxrfXbEAUXwRV?format=jpg&name=small)
...
## Lesson 3: From RAG to Self-Directed Search
...
## Lesson 4: Progressive Disclosure and Skills
...
## Lesson 5: Keeping the Tool Count Low

Claude Code currently has around 20 tools, and we are constantly asking ourselves if we need all of them. The bar to add a new tool is high, because this gives the model one more option to think about.
